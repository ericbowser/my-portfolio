...
const Nav = ({props}) => {
    ...
    return (
        <nav className={'dark:backdrop-blur-lg fixed top-0 left-0 right-0 backdrop-blur-lg bg-white/30 border-b border-gray-200 p-10'}>
            ...
            <section className={'absolute top-2 right-1/2 z-50 dark:bg-gray-800 dark:text-white'}>
                <div onClick={scrollTo}>
                    <FiDribbble className={'animate-move dark:text-white'} size={50}/>
                </div>
            </section>
            <section className={'absolute top-2 right-2 dark:bg-gray-800 dark:text-white m-12'}>
                <ul>
                    <li>
