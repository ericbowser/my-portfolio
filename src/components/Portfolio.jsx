...
const PROJECTS = [
  {
    title: "TrackMoto",
    subtitle: "Motorcycle Mileage & Expense Tracker",
    stack: ["React Native", "Expo Router", "AsyncStorage", "expo-location", "EAS Build"],
    splash: "#FF6B35",
    badge: "Google Play � Coming Soon",
    description:
      "Mobile app for motorcycle riders to log daily miles and capture receipts for IRS actual expense tracking. Fills the gap every major mileage app misses � motorcycles can't use the standard mileage rate.",
    links: {
  ...
  {
    title: "DocuCreate",
    subtitle: "State-Informed Lease Agreements",
    stack: ["React", "Node.js", "PDF Generation", "E-Signature", "Docker"],
    splash: "#00E5A0",
    badge: "Live",
    description:
      "Generate professional rental lease agreements with state-specific guidance. Includes PDF download and e-signature support. Built for landlords who need a fast, compliant starting point.",
    links: {
  ...
  {
    title: "LaserTags",
    subtitle: "Smart Pet ID Tags",
    stack: ["React", "Node.js", "PostgreSQL", "Docker", "JWT", "QR Code"],
    splash: "#3B82F6",
    badge: "In Progress",
    description:
      "Smart pet ID tags with QR code generation � scan a tag to instantly surface owner contact info. JWT authentication and containerized microservices.",
    links: {
  ...
  {
    title: "Wasatch Rockhound",
    subtitle: "Gear Reviews for the American West",
    stack: ["React Native", "Node.js", "Maps API", "Content Platform"],
    splash: "#E040FB",
    badge: "Live",
    description:
      "Affiliate gear review site for rockhounds on Utah BLM land and desert terrain. Reviews metal detectors, rock hammers, GPS units, and field gear chosen for the American West.",
    links: {
  ...
  },
  {
    ...
    subtitle: "Multi-Provider LLM Integrations",
    stack: ["React", "TypeScript", "Node.js", "Express", "OpenAI", "Gemini", "Claude"],
    splash: "#E040FB",
    badge: "Live",
    description:
      "Unified AI toolkit integrating OpenAI, Google Gemini, and Anthropic Claude. Real-time streaming, prompt engineering patterns, and secure API key management.",
    links: {
  ...
  },
  {
    ...
    splash: "#FACC15",
    description:
      "Full-stack study platform for CompTIA Cloud+ and AWS certifications. Spaced repetition algorithms, practice exams, and real-time progress analytics.",
    links: {
...
// ─── SPARKLE BURST (on hover for cards) ─────────────────
    ...
    <section id="about" style={{
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <Reveal>
          <p style={{
            fontFamily: "'IBM Plex Mono', monospace", fontSize: 12,
            letterSpacing: "0.2em", textTransform: "uppercase", color: "#666", marginBottom: 24,
          }}>
        ...
        <Reveal delay={100}>
          <h1 style={{
            ...
            lineHeight: 1.0, color: "#FFF", margin: 0, letterSpacing: "-0.02em",
          }}>
            Eric<br />Bowser
          </h1>
        </Reveal>
        ...
        <Reveal delay={200}>
          <div style={{ maxWidth: 520, marginTop: 40 }}>
            <p style={{
              ...
              fontSize: 16, lineHeight: 1.7, color: "#AAA", margin: 0,
            }}>
        ...
        <Reveal delay={300}>
          <div style={{ display: "flex", gap: 20, marginTop: 40, flexWrap: "wrap" }}>
            {[
              ...
              { label: "Resume", href: "/resume.pdf", download: "Eric_Bowser_Resume.pdf" },
            ].map((l, i) => (
              <a key={l.label} href={l.href} target={l.download ? "_self" : "_blank"} rel="noopener noreferrer" download={l.download} style={{
                fontFamily: "'IBM Plex Mono', monospace", fontSize: 12,
                letterSpacing: "0.1em", textTransform: "uppercase",
                color: "#FFF", textDecoration: "none",
                borderBottom: `1px solid ${VIVID[i]}`, paddingBottom: 2,
      ...
      <div>
        {EXPERIENCE.map((exp, i) => (
          <Reveal key={i} delay={i * 100}>
            <div
              style={{
                borderTop: `1px solid ${expanded === i ? exp.color : "#D0D0D0"}`,
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
                <div>
                  <h3 style={{
                    fontFamily: "'Playfair Display', Georgia, serif",
                    fontSize: "clamp(24px, 3vw, 36px)", fontWeight: 400, margin: 0,
                    color: expanded === i ? exp.color : "#000",
                    transition: "color 0.4s ease",
                  }}>
                    {exp.company}
                  </h3>
                  <p style={{ fontFamily: "'Source Serif 4', Georgia, serif", fontSize: 14, color: "#888", margin: "8px 0 0 0" }}>
                    {exp.role}
                  </p>
                </div>
                <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 12, color: "#888", letterSpacing: "0.05em", whiteSpace: "nowrap" }}>
                  {exp.period}
                </span>
              </div>
              ...
              <div style={{ maxHeight: expanded === i ? 400 : 0, overflow: "hidden", transition: "max-height 0.4s ease" }}>
                <ul style={{ marginTop: 24, paddingLeft: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 12 }}>
                  {exp.bullets.map((b, j) => (
                    <li key={j} style={{
                      fontFamily: "'Source Serif 4', Georgia, serif", fontSize: 14, lineHeight: 1.6,
                      color: "#555", paddingLeft: 16, borderLeft: `2px solid ${exp.color}`,
                    }}>
                      {b}
                    </li>
                  ))}
              ...
              <span style={{
                ...
                fontSize: 11, color: expanded === i ? exp.color : "#888",
                marginTop: 16, letterSpacing: "0.1em", textTransform: "uppercase",
                transition: "color 0.3s",
              }}>
...
function ProjectCard({ project, index }) {
  const { containerRef, handleMouseMove, sparkleElements } = useSparkleTrail();
  ...
  return (
    <Reveal delay={index * 80}>
      <div
        ...
        style={{
          border: "1px solid #D0D0D0", padding: 32, cursor: "default",
          position: "relative", overflow: "hidden",
          transition: "border-color 0.3s, box-shadow 0.3s",
          borderColor: hovered ? project.splash : "#D0D0D0",
          boxShadow: hovered ? `0 0 30px ${project.splash}22, 0 0 60px ${project.splash}11` : "none",
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <span style={{
              ...
              color: hovered ? project.splash : "#888",
            ...
            {project.badge && (
              <span style={{
                ...
                padding: "3px 8px",
                border: `1px solid ${project.splash}88`,
                color: project.splash, borderRadius: 2,
              }}>
                {project.badge}
              </span>
            )}
          ...
          <h3 style={{
            ...
            fontWeight: 400, margin: "20px 0 4px", color: "#000",
          }}>
            {project.title}
          </h3>
          <p style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 11, color: "#888", letterSpacing: "0.05em", margin: "0 0 16px" }}>
            {project.subtitle}
          </p>
          <p style={{ fontFamily: "'Source Serif 4', Georgia, serif", fontSize: 14, lineHeight: 1.7, color: "#555", margin: "0 0 20px" }}>
            {project.description}
          </p>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
            {project.stack.map((t) => (
              <span key={t} style={{
                ...
                padding: "4px 10px",
                border: `1px solid ${hovered ? project.splash + "66" : "#D0D0D0"}`,
                color: hovered ? project.splash : "#555",
  ...
  return (
    <section id="projects" style={{ padding: "100px clamp(24px, 6vw, 120px)", background: "#FFF" }}>
      ...
      <div style={{
        ...
        gap: 1, background: "#D0D0D0", border: "1px solid #D0D0D0",
      }}>
        {PROJECTS.map((p, i) => (
  ...
  return (
    <li
      ...
      style={{
        ...
        paddingLeft: 12,
        borderLeft: hovered ? `2px solid ${color}` : "1px solid #D0D0D0",
          ...
          <Reveal key={category} delay={ci * 80}>
            <div>
              <h4 style={{
                ...
                color: "#000", margin: "0 0 20px", paddingBottom: 12,
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 10 }}>
                {items.map((item) => (
                  <SkillItem key={item} item={item} color={color} />
                ))}
              </ul>
            </div>
          </Reveal>
...
function ContactSection() {
  return (
    <section id="contact" style={{
      padding: "100px clamp(24px, 6vw, 120px)", background: "#000", color: "#FFF",
      position: "relative", overflow: "hidden",
    }}>
      <div style={{ position: "relative", zIndex: 1 }}>
        <Reveal>
          <SectionLabel number="04" label="Contact" dark />
        </Reveal>
        ...
        <Reveal delay={100}>
          <h2 style={{
            ...
            lineHeight: 1.1, margin: "0 0 32px", maxWidth: 600,
          }}>
        ...
        <Reveal delay={200}>
          <p style={{
            ...
            lineHeight: 1.7, color: "#999", maxWidth: 480, margin: "0 0 40px",
          }}>
          ...
          <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
            {[
              ...
              <a key={l.label} href={l.href} target="_blank" rel="noopener noreferrer" style={{
                ...
                letterSpacing: "0.1em", textTransform: "uppercase",
                color: "#FFF", textDecoration: "none",
                padding: "12px 28px", border: "1px solid #FFF",
                transition: "background 0.3s, color 0.3s, border-color 0.3s, box-shadow 0.3s",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = VIVID[i];
                e.currentTarget.style.borderColor = VIVID[i];
                e.currentTarget.style.boxShadow = `0 0 20px ${VIVID[i]}44`;
              }}
              onMouseLeave={(e) => {
...
function Footer() {
  return (
    <footer style={{
      padding: "24px clamp(24px, 6vw, 120px)", background: "#000",
